    ...
    return (
        <div>
            <div class="m-2 flex h-16 items-center justify-evenly font-semibold">
                ...
                <div><button class="rounded border border-[#d4d4d4] bg-transparent py-[8px] px-[16px] font-semibold text-black hover:border-[#143fcd] hover:bg-[#eaebff] hover:text-[#143fcd]">Log In</button> <button class="rounded border border-[#d4d4d4] bg-black py-[8px] px-[16px] font-semibold text-white hover:border-[#143fcd] hover:bg-[#143fcd]">Sign Up</button></div>
            </div>
